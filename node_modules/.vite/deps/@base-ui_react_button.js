...
var CompositeRootContext = React2.createContext(void 0);
if (true) CompositeRootContext.displayName = "CompositeRootContext";
function useCompositeRootContext(optional = false) {
  const context = React2.useContext(CompositeRootContext);
...
function useButton(parameters = {}) {
  ...
  const updateDisabled = React4.useCallback(() => {
  ...
  const getButtonProps = React4.useCallback((externalProps = {}) => {
    const {
...
// node_modules/@base-ui/react/esm/button/Button.js
var Button = React5.forwardRef(function Button2(componentProps, forwardedRef) {
  const {
    render,
    className,
    disabled = false,
